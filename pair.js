...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://files.catbox.moe/sup4af.jpeg',
    GROUP_INVITE_LINK: '',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/sup4af.jpeg',
    NEWSLETTER_JID: '120363404965926337@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '94741856766',
    BOT_FOOTER: '> 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 ᴩᴀꜱɪʏᴀ-𝐌𝙳 𝐕.2 🥷🇱🇰',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbC4A7X9Gv7ZiGIg6D1r'
};
...
╰───────────────⭓`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: 'ᴍᴀᴅᴇ ɪɴ ʙʏ ᴩᴀꜱɪʏᴀ ᴍᴅ',
                serverMessageId: -1
            }
        };
...
`;
    ...
    const menuMessage = {
      image: { url: "https://files.catbox.moe/sup4af.jpeg" },
      caption: `*ᴍɪɴɪ ᴩᴀꜱɪʏᴀ ᴍᴅ*\n${menuText}`,
      buttons: [
        {
          buttonId: `${config.PREFIX}quick_commands`,
          buttonText: { displayText: 'ᴍɪɴɪ ᴩᴀꜱɪʏᴀ ᴍᴅ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: 'ᴍɪɴɪ ᴩᴀꜱɪʏᴀ ᴍᴅ ᴄᴍᴅs',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: 'ᴍɪɴɪ ᴩᴀꜱɪʏᴀ ᴍᴅ',
                  rows: [
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *ᴍɪɴɪ ᴩᴀᴀɪʏᴀ ᴍᴅ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
                    ...
                    await socket.sendMessage(sender, { react: { text: '✔️', key: msg.key } });
                        ...
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '🌌 ᴩᴀꜱɪʏᴀ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ɴᴀsᴀ ɴᴇᴡs',
                                `🌠 *${title}*\n\n${explanation.substring(0, 200)}...\n\n📆 *ᴅᴀᴛᴇ*: ${date}\n${copyright ? `📝 *ᴄʀᴇᴅɪᴛ*: ${copyright}` : ''}\n🔗 *Link*: https://apod.nasa.gov/apod/astropix.html`,
                                'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴩᴀꜱɪʏᴀ ʙᴏʏ'
                            )
                        });
                    } catch (error) {
...
//===============================
                  ...
                  await socket.sendMessage(sender, { react: { text: '🔮', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: imageBuffer,
                            caption: `🧠 *ᴩᴀꜱɪʏᴀ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴀɪ ɪᴍᴀɢᴇ*\n\n📌 ᴘʀᴏᴍᴘᴛ: ${prompt}`
                        }, { quoted: fakevCard });
                    } catch (err) {
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ᴍɪɴɪ ᴩᴀꜱɪʏᴀ ᴍᴅ ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴍɪɴɪ ᴩᴀꜱɪʏᴀ ᴍᴅ
╭───────────────⭓
